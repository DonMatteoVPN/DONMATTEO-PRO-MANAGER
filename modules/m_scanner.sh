...
menu_scanner() {
    ...
    while true; do
        ...
        echo -e " ${YELLOW}3.${NC} Бесконечный поиск ${GRAY}(Infinity Mode)${NC}"
        ...
        echo -e " ${YELLOW}5.${NC} Сбор и скан доменов по ${GRAY}URL${NC}"
        echo -e " ${GRAY}   └─ Вытаскивает и проверяет домены с любой веб-страницы.${NC}"
        echo -e "${BLUE}------------------------------------------------------${NC}"
        echo -e " ${CYAN}8.${NC} 📂 Менеджер Отчетов ${GRAY}(Анализ / Просмотр / Удаление)${NC}"
